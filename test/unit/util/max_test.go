...
func TestArrayMax_EmptyPanics(t *testing.T) {
	require.PanicsWithValue(
		...
		func() { util.ArrayMax[float64](nil) },
	)
	require.PanicsWithValue(
		t,
		"util.ArrayMax: empty slice — caller must guard len(data) > 0",
		func() { util.ArrayMax[float64]([]float64{}) },
	)
}
