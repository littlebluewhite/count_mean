...
func testPhaseAnalysisResultJSONDeserialization(t *testing.T) {
	...
	var result PhaseAnalysisResult
...
func TestDataFlow(t *testing.T) {
	...
	// 反序列化
	var deserializedDataset EMGDataset
